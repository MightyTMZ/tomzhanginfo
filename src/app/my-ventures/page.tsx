    ...
    <div className={styles.pageContainer}>
      ...
      <section className={styles.ventureSection}>
        ...
        <p>
          ...
          expertise, enabling them to share knowledge effortlessly while opening
        ...
        <ul className={styles.visionList}>
          <li>
            Professionals can upload and manage their knowledge base seamlessly.
          </li>
          <li>
          ...
          <li>
            Bridging the gap between trust, personalization, and accessibility.
          </li>
        </ul>
        <p>
      ...
      <section className={styles.ventureSection}>
        ...
        <p>
          ...
          popularity due to its privacy and low-cost way to use language models
          locally on your devices. In other words, you can now use AI on your
          own laptop or device without having to send all your data over on
          cloud.
        </p>
        <p>
